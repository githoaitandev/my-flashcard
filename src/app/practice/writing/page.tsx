  ...
  useEffect(() => {
    const fetchCards = async () => {
      try {
        ...
        cardsUrl.searchParams.append("limit", "10"); // Fetch up to 10 cards for writing practice
    ...
    return (
      <div className="max-w-xl mx-auto">
        <PageHeader
          ...
          description="Great job! You've completed this writing practice session"
        />
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-8">
        <PageHeader
          title={getPageTitle()}
          description="Practice writing English words"
        />
